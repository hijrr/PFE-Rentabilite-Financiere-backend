...
from app.routers import Dashboard, GestionHistorique, GestionProjet, GestionRentabilite, GestionRole, GestionSalaries, PredictionIA, Reporting, Simulation, chatbot
